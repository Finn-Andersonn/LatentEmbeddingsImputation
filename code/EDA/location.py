# ----------------------------------------
# Understanding if some satellites took precedence in capturing images
# As in, did some circle the area of Louisiana more frequently? When? Was it the whole area or just Baton Rouge, for example?
# ----------------------------------------
...
class Location(Weather):
    '''
    Description: 
        Plots how many images were taken by each satellite and added to the dataframe
        Further identifying areas of inconsitencies

    Args:
        df: Pandas Dataframe

    Returns:
        Histogram: Satellite images sourced by year/month
    '''
